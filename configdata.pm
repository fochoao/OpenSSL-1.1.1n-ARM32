...
our %config = (
  ...
  builddir => ".",
  cflags => [  ],
  conf_files => [ "C:\\cpython\\externals\\openssl-1.1.1m\\Configurations\\00-base-templates.conf", "C:\\cpython\\externals\\openssl-1.1.1m\\Configurations\\10-main.conf", "C:\\cpython\\externals\\openssl-1.1.1m\\Configurations\\50-win-onecore.conf" ],
  cppflags => [  ],
  cxxflags => [  ],
  defines => [ "NDEBUG" ],
